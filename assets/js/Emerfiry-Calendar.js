...
$(function () {
    ...
    var base_url = 'http://localhost/MHCS/'; // Here i define the base_url
    ...
    $('#calendar').fullCalendar({
        ...
        events: base_url + 'schoolERP/getEvents',
        // Handle Day Click
        ...
        eventDrop: function (event, delta, revertFunc) {
            ...
            $.post(base_url + 'schoolERP/dragUpdateEvent', {
                id: event.id,
    ...
    $('.modal').on('click', '#add-event', function (e) {
        if (validator(['title', 'description'])) {
            $.post(base_url + 'schoolERP/addEvent', {
                title: $('#title').val(),
    ...
    $('.modal').on('click', '#update-event', function (e) {
        if (validator(['title', 'description'])) {
            $.post(base_url + 'schoolERP/updateEvent', {
                id: currentEvent._id,
                title: $('#title').val(),
                description: $('#description').val(),
                color: $('#color').val(),
    ...
    $('.modal').on('click', '#delete-event', function (e) {
        $.get(base_url + 'schoolERP/deleteEvent?id=' + currentEvent._id, function (result) {
            $('.modal').modal('hide');
            $('#calendar').fullCalendar("refetchEvents");
        });
    });
