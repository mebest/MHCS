<div class="cell auto-size padding20 bg-white" id="cell-content">
    <h1 class="text-light">Change Password<span class="mif-medkit place-right"></span></h1>
        ...
        <div class="row">
            ...
            <div class="cell colspan6">
                <div class="panel success">
                    ...
                    <div class="content">
                        <center><br><br>
                            <form data-role="validator" action="<?php echo base_url(); ?>schoolERP/changePass?user_id=<?= $user_id ?>" method="post">
                                <fieldset>
